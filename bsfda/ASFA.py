...
def main(data: MIDataLoader,
    ...
    for t in range(data.nSubjects):
        ...
        newF, newB, newC = trainTarget(netF, netB, netC, ft, args)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="black-ASFA")
    ...
    parser.add_argument('--output', type=str, default='black-ASFA')
