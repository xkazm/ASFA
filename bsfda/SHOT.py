...
def trainTarget(netF: nn.Module,
    ...
    for epoch in range(args.num_epochs_t):
        ...
        if (epoch + 1) % args.interval == 0:
            y_pred = obtain_label(x_device, newF, newB, newC, args)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="black-SHOT")
    ...
    parser.add_argument('--output', type=str, default='black-SHOT')
