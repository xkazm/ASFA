...
def train(xs: torch.Tensor,
    ...
    domain_discriminator = DomainDiscriminator(input_dim=args.bottleneck_dim, hidden_dim=args.hidden_dim)
    ...
    adv_loss = DomainAdversarialLoss(domain_discriminator=domain_discriminator, grl=grl).to(args.device)
    ...
    for iter in range(iters):
        ...
        transfer_loss = adv_loss(fxs, fxt, iter)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output', type=str, default='DANN')
