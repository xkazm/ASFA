...
from libs.loss import ClassConfusionLoss
...
def train(xs: torch.Tensor,
    ...
    mcc_loss = ClassConfusionLoss(t=args.t_mcc)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="MCC")
    ...
    parser.add_argument('--output', type=str, default='MCC')
