...
from libs.loss import LabelSmooth, TEntropyLoss, ConsistencyLoss, WeightedInformationMaximization
...
def trainTarget(netF: nn.Module,
    ...
    for epoch in range(args.num_epochs_t):
        ...
        loss_mcc = TEntropyLoss(t=args.t_mcc, order=args.order)(out)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="ASFA")
    ...
    parser.add_argument('--output', type=str, default='ASFA')
